...
function App(): React.JSX.Element {
  return (
    <div>
      <Legend label='Rotate Counterclockwise' withBackground>
        <span slot='block'>
          A
        </span>
        <div slot='block'>
      ...
      <Legend label='Interact' withBackground type='long'>
        <div slot='block'>
      ...
      <Legend label='Move Forward' withBackground>
        <span slot='block'>W</span>
      </Legend>

      <Legend label='Rotate Clockwise' withBackground>
        <span slot='block'>
          D
        </span>
        <div slot='block'>
      ...
      <Legend label='Scroll to Climb' type='large'>
        <div slot='block'>
          <svg width="64" height="88" viewBox="0 0 64 88" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="29" y="17" width="2" height="8" rx="1" fill="#D9D9D9" />
            <defs>
